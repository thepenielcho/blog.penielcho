...
![로딩 에러 메시지](../../assets/resources/github-ipynb-loading/01.png)
해당 링크를 넣으면,
![nbviewer에 링크 넣기](../../assets/resources/github-ipynb-loading/02.png)
아래와 같이 깃헙에서 로딩되지 않던 ipynb파일이 로딩된다. 이때, ipynb 파일이 로딩되지 않는 경우도 있다. 이 경우 동일한 파일을 다시 커밋하여 해당 파일 링크를 nbviewer로 넣어보면 열린다.
![해당 ipynb 파일 내용](../../assets/resources/github-ipynb-loading/03.png)
### 바인더를 통해 build
![binder 엠블럼](../../assets/resources/github-ipynb-loading/04.png)
뷰어 우측 상단에 보면 반 잘린 올림픽 엠블럼 같은 버튼이 있는데, 이걸 클릭해보자.
![binder 실행 화면](../../assets/resources/github-ipynb-loading/05.png)
클릭 후에 binder라는 창이 뜨며 주피터 노트북 파일 렌더를 시작한다. 잠깐 기다려주면 아래와 같이 주피터 화면이 뜬다.
![렌더 완료된 온라인 주피터 화면](../../assets/resources/github-ipynb-loading/06.png)
이 화면을 보고 있다면 문제는 해결되었다는 뜻!
### 문제해결 완료!
![깃헙에서도 로딩 성공!](../../assets/resources/github-ipynb-loading/07.png)
